...
namespace BartenderService.Controllers
{
    public class CocktailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DrinkName,Description,Price")] Cocktail cocktail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DrinkName,Description,Price")] Cocktail cocktail)
        {
            if (id != cocktail.ID)
            {
                return NotFound();
